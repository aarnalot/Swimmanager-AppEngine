 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "brainstorm.com", ownerName = "brainstorm.com", packagePath="swimmanager"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyBaQ9FcBx5O1WDIUb0dDdrz6nhnNYehXak";
